...
const TeacherManagement=()=>{
    ...
    const validateForm = () => {
        ...
        if (!teacherFirstName.trim()) {
            errors.teacherFirstName = 'First Name is required';
            isValid = false;
        }
 
        if (!teacherLastName.trim()) {
            errors.teacherLastName = 'Last Name is required';
            isValid = false;
        }
        ...
        if (!teacherPhoneno.trim()) {
            errors.teacherPhoneno = 'Phone NO  is required';
            isValid = false;
        }
